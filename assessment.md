...
- Windows distribution: PASS locally and in hosted CI on 2026-09-08. The local Python 3.13 build produced a 90,051,015-byte portable ZIP and a 67,892,875-byte installer. Frozen GUI import, CLI help, synthetic project creation, exact snapshot recovery, DOCX, PDF, and EPUB export, install, upgrade, Start menu shortcut, uninstall, and user-project preservation all passed. [Run 34305049663](https://github.com/mickpletcher/openscribe/actions/runs/34305049663) independently built and uploaded the packages on GitHub's Windows runner after repeating the install, upgrade, uninstall, and project-preservation smoke tests.
